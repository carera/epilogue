...
var Resource = function(options) {
  ...
  this.actions.forEach(function(action) {
    ...
    hooks.forEach(function(hook) {
      self[action][hook] = function(options, f) {
        self.controllers[action].milestone(hook, options, f);
      };

      self[action][hook].before = function(options, f) {
        self.controllers[action].milestone(hook + '_before', options, f);
      };

      self[action][hook].after = function(options, f) {
        self.controllers[action].milestone(hook + '_after', options, f);
      };
    });
  });
