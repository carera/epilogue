...
/**
  ...
  @param {boolean}  options.override - if true, overrides all milestone hooks with the current one
  @param {function} callback - callback function handling the milestone
*/
Controller.prototype.milestone = function() {
  var name, options, callback;
  name = arguments[0];
